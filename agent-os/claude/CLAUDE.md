...
- `distill-rules` — (builder-model maintenance task — Agent OS repo or installed adapter logs) semantically cluster logs, propose rule promotions/merges/conflict resolutions with verbatim evidence; diffs require approval.
